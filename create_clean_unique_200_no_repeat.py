...
# ===================================================================
def main() -> int:
    src_path = Path("fish_frame_measurements_groups_relaxed.csv")
    weights_path = Path("weights.csv")
    out_path = Path("fish_frames_200_clean_unique_no_repeat.csv")
    old_path = Path("fish_frames_200_clean_unique_no_repeat_OLD.csv")
    rep_path = Path("fish_frames_200_clean_unique_no_repeat_report.txt")
